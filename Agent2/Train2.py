...
policy_net = torch.load('Nets2/policy_net2.ckpt') #loading latest trained policy net
target_net = torch.load('Nets2/target_net2.ckpt') #loading lastest trained target net
...
torch.save(policy_net, 'Agent2/policy_net2.ckpt')
torch.save(target_net, 'Agent2/target_net2.ckpt') 
